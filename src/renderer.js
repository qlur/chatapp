...
class RegisterBox extends React.Component {
  ...
  handleRegisterSubmit(e) {
    ...
    if (!checkEmail(this.state.email)) {
      alert("Please Enter A SHSU Address!");
      return false;
    }else {
      alert("Yaaaayy! Welcome to ChatApp. But for security, we require you to login again.")
    }
  ...
  render() {
    return (
      <div className="login-box">
        ...
        <img src="../dist/images/logoproj.png"></img>
        </div>
          <h3 className="text-center">Welcome to SHSU ChatApp</h3>{" "}
...
<label className="myCheckbox">
  <input type="checkbox" name="test" />
           <label for="test">I agree to SHSU ChatApp's Terms and Privacy policies</label>
          ...
          <a className="login-btn-reg" href="#" onClick={this.props.handleLoginClick}>
    ...
    return (
      this.state.isOpen && (
        ...
        <img src="../dist/images/logoproj.png"></img>
            ...
            <h3 className="text-center">Login to SHSU ChatApp!</h3>{" "}
            <div className="form-group">
            ...
            <a href="#"  className="login-btn-reg" onClick={this.props.handleRegisterClick}>
              New to ChatApp? Register{" "}
            </a>{" "}
            <span className="tos">By signing in, you agree to SHSU ChatApp's <a>Terms</a> and <a>Privacy policies</a>.</span>
          </div>{" "}
        </div>
      )
    );
